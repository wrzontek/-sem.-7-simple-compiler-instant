...
#define yyparse         instant_parse
#define yylex           instant_lex
#define yyerror         instant_error
#define yydebug         instant_debug
#define yynerrs         instant_nerrs
...
#ifndef YY_INSTANT_BISON_H_INCLUDED
# define YY_INSTANT_BISON_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 1
#endif
#if YYDEBUG
extern int instant_debug;
#endif
...
int instant_parse (yyscan_t scanner, YYSTYPE *result);

#endif /* !YY_INSTANT_BISON_H_INCLUDED  */
...
{
       0,    98,    98,   100,   101,   103,   104,   105,   107,   108,
     110,   111,   113,   114,   115,   117,   118,   119,   121
};
#endif
...
static const char *const yytname[] =
{
  ...
  "_PLUS", "_MINUS", "_SLASH", "_SEMI", "_EQ", "_INTEGER_", "_IDENT_",
  "$accept", "Program", "Stmt", "ListStmt", "Exp1", "Exp2", "Exp3", "Exp4",
  "Exp", YY_NULLPTR
};
#endif
...
{
      -3,     2,   -17,     1,    11,     6,   -17,   -17,     0,    -4,
     -17,   -17,   -17,    12,     2,   -17,    -3,     2,     2,     2,
       2,   -17,   -17,   -17,   -17,    -4,   -17,   -17
};
...
{
      13,     1,    19,    26,    27,    20,     1,    17,    18,     2,
       3,    15,    14,    22,     2,    12,    16,    21,     0,    23,
       0,    24,     0,    25
};

static const yytype_int8 yycheck[] =
{
       1,     4,     6,    19,    20,     9,     4,     7,     8,    12,
      13,     0,    11,    14,    12,    13,    10,     5,    -1,    16,
      -1,    17,    -1,    18
};
...
{
       0,     4,    12,    13,    15,    16,    17,    18,    19,    20,
      21,    22,    13,    22,    11,     0,    10,     7,     8,     6,
       9,     5,    22,    17,    18,    20,    21,    21
};
...
yyreduce:
  ...
  case 2:
#line 98 "instant.y"
                   { std::reverse((yyvsp[0].liststmt_)->begin(),(yyvsp[0].liststmt_)->end()) ;(yyval.program_) = new Prog((yyvsp[0].liststmt_)); result->program_ = (yyval.program_); }
#line 1495 "Parser.C"
    break;

  case 3:
#line 100 "instant.y"
                       { (yyval.stmt_) = new SAss((yyvsp[-2]._string), (yyvsp[0].exp_)); result->stmt_ = (yyval.stmt_); }
#line 1501 "Parser.C"
    break;

  case 4:
#line 101 "instant.y"
        { (yyval.stmt_) = new SExp((yyvsp[0].exp_)); result->stmt_ = (yyval.stmt_); }
#line 1507 "Parser.C"
    break;

  case 5:
#line 103 "instant.y"
                       { (yyval.liststmt_) = new ListStmt(); result->liststmt_ = (yyval.liststmt_); }
#line 1513 "Parser.C"
    break;

  case 6:
#line 104 "instant.y"
         { (yyval.liststmt_) = new ListStmt(); (yyval.liststmt_)->push_back((yyvsp[0].stmt_)); result->liststmt_ = (yyval.liststmt_); }
#line 1519 "Parser.C"
    break;

  case 7:
#line 105 "instant.y"
                        { (yyvsp[0].liststmt_)->push_back((yyvsp[-2].stmt_)); (yyval.liststmt_) = (yyvsp[0].liststmt_); result->liststmt_ = (yyval.liststmt_); }
#line 1525 "Parser.C"
    break;

  case 8:
#line 107 "instant.y"
                       { (yyval.exp_) = new ExpAdd((yyvsp[-2].exp_), (yyvsp[0].exp_)); result->exp_ = (yyval.exp_); }
#line 1531 "Parser.C"
    break;
...
#line 1537 "Parser.C"
  ...
  case 10:
#line 110 "instant.y"
                        { (yyval.exp_) = new ExpSub((yyvsp[-2].exp_), (yyvsp[0].exp_)); result->exp_ = (yyval.exp_); }
#line 1543 "Parser.C"
    break;
...
#line 1549 "Parser.C"
  ...
  case 12:
#line 113 "instant.y"
                       { (yyval.exp_) = new ExpMul((yyvsp[-2].exp_), (yyvsp[0].exp_)); result->exp_ = (yyval.exp_); }
#line 1555 "Parser.C"
    break;

  case 13:
#line 114 "instant.y"
                     { (yyval.exp_) = new ExpDiv((yyvsp[-2].exp_), (yyvsp[0].exp_)); result->exp_ = (yyval.exp_); }
#line 1561 "Parser.C"
    break;
...
#line 1567 "Parser.C"
  ...
  case 15:
#line 117 "instant.y"
                 { (yyval.exp_) = new ExpLit((yyvsp[0]._int)); result->exp_ = (yyval.exp_); }
#line 1573 "Parser.C"
    break;

  case 16:
#line 118 "instant.y"
            { (yyval.exp_) = new ExpVar((yyvsp[0]._string)); result->exp_ = (yyval.exp_); }
#line 1579 "Parser.C"
    break;
